...
class BiomechanicsEngine {
    ...
    private fun calculateAngleBetweenPoints(point1: Point3D, vertex: Point3D, point3: Point3D): Double {
    ...
    private fun calculateDistance(point1: Point3D, point2: Point3D): Double {
    ...
    private fun getAverageHipPosition(pose: PoseData): Point3D? {
        ...
        return when {
            leftHip != null && rightHip != null -> Point3D(
